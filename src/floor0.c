...
static const uint16_t barklook[54]={
...
void vorbis_lsp_to_curve(int32_t *curve,int n,int ln,
			 int32_t *lsp,int m,
			 int32_t amp,
			 int32_t ampoffset,
			 int32_t nyq){
...
int32_t *floor0_inverse1(vorbis_dsp_state *vd,vorbis_info_floor *i,
			     int32_t *lsp){
  vorbis_info_floor0 *info=(vorbis_info_floor0 *)i;
  int j,k;
